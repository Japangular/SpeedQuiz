...
import com.japangular.quizzingbydoing.backendspeed.features.extractCardsFromUrl.CardsFromUrlModel;
import com.japangular.quizzingbydoing.backendspeed.externalClients.wanikani.client.WaniKaniProvider;
...
public class WaniKaniDeckAdapter {
    ...
    public List<DeckInfo> listDecks(String claimedName, String tokenHash) {
        ...
        return List.of(DeckInfo.builder()
