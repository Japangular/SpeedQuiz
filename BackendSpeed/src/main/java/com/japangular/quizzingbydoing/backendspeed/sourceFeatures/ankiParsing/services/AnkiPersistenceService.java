...
import com.japangular.quizzingbydoing.backendspeed.sourceFeatures.ankiParsing.entity.UserTableState;
import com.japangular.quizzingbydoing.backendspeed.sourceFeatures.ankiParsing.repository.UserTableStateRepository;
...
public class AnkiPersistenceService {
  ...
  public void overwritePersistIgnoredAnkiRows(String[] ignoredRowIds) {
    ...
    logger.info("already persisted: {}", alreadyPresent);
